...
The CDISC Foundational Standards in RDF haven been complemented by a Reference Guide and a User Guide. The package has completed CDISC Public Review as of 30.07.2015. Currently the RDF files are available from this GitHub repository, whereas the guides can be downloaded from the CDISC web site. For more information and access to the guides, please refer to the CDISC web site http://www.cdisc.org/rdf.
